...
import './english.scss'
import english from '../../../../src/Image/english.svg'
            ...
            <div className="container">
                <div className="english">
                    <div className="english--title">
                        <h1>What is IELTS?</h1>
                        <div className="english--title__tome"></div>
                        <img src={english} alt=""/>
                        ...
                        <div className="english--title__list">
                            <li>Listening</li>
                            <li>Reading</li>
                            <li>Writing</li>
                            <li>Speaking</li>
                        ...
                        <div className="english--title__lol">
